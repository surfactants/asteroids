...
inline std::string damageTypeToString(Damage::Type t){
    ...
    else if(t == Damage::EXPLOSIVE) return "EXPLOSIVE";
    else if(t == Damage::FIRE) return "FIRE";
    else if(t == Damage::PLASMA) return "PLASMA";
    else if(t == Damage::LASER) return "LASER";
    else if(t == Damage::ELECTRIC) return "ELECTRIC";
    else return std::string("NULL_TYPE");
}
...
inline Damage::Type stringToDamageType(std::string s){
    ...
    else if(s == "EXPLOSIVE") return Damage::EXPLOSIVE;
    else if(s == "FIRE") return Damage::FIRE;
    else if(s == "PLASMA") return Damage::PLASMA;
    else if(s == "LASER") return Damage::LASER;
    else if(s == "ELECTRIC") return Damage::ELECTRIC;
